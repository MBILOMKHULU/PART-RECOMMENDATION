...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull RelativeLayout rootView, @NonNull Button buttonLogin,
      @NonNull Button buttonSign, @NonNull EditText editTextName,
      @NonNull EditText editTextPassword, @NonNull TextView textViewTitle) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((RelativeLayout) rootView, buttonLogin, buttonSign,
          editTextName, editTextPassword, textViewTitle);
    }
